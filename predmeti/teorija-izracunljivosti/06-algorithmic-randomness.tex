...
\vprasanje{What is a naive non-randomness test and what is a Martin-Löf
  non-randomness test?}
...
\vprasanje{Show that computable sequences are not ML random.}
...
\vprasanje{Show that there exists a universal ML test.}
