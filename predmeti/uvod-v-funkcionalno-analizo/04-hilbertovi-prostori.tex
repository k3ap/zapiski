...
\vprasanje{Če je $M$ zaprt podprostor v Hilbertovem prostoru in $x_0 \in M$,
  potem je $x - x_0$ pravokoten na $M$ natanko tedaj, ko je $d(x,M) =
  \norm{x-x_0}$.}
...
\vprasanje{Pokaži, da je vsak Hilbertov prostor refleksiven.}
